...
def dictLocation():
     loc = pd.read_excel(dirpath+'/australia/SUA_LatLong.xlsx')
     dictLoc={}
...
def dictAreas():
     areas = pd.read_excel(dirpath+'australia/SUA_association_2016_2021.xlsx')
     dictArea21={}
...
def dictIncomeAndPopulation():
     pop = pd.read_csv(dirpath+'australia/top2021.csv')
     dictIncome={}
     dictPop={}
